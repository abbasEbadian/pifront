...
const STYLES = {
  ...
  'vendor/colors-dark': './src/vendor/styles/rtl/colors-dark.scss',
  ...
  'vendor/theme-air-dark': './src/vendor/styles/rtl/theme-air-dark.scss',
  ...
  'vendor/theme-corporate-dark': './src/vendor/styles/rtl/theme-corporate-dark.scss',
  ...
  'vendor/theme-cotton-dark': './src/vendor/styles/rtl/theme-cotton-dark.scss',
  ...
  'vendor/theme-gradient-dark': './src/vendor/styles/rtl/theme-gradient-dark.scss',
  ...
  'vendor/theme-paper-dark': './src/vendor/styles/rtl/theme-paper-dark.scss',
  ...
  'vendor/theme-shadow-dark': './src/vendor/styles/rtl/theme-shadow-dark.scss',
  ...
  'vendor/theme-soft-dark': './src/vendor/styles/rtl/theme-soft-dark.scss',
  ...
  'vendor/theme-sunrise-dark': './src/vendor/styles/rtl/theme-sunrise-dark.scss',
  ...
  'vendor/theme-twitlight-dark': './src/vendor/styles/rtl/theme-twitlight-dark.scss',
  ...
  'vendor/theme-vibrant-dark': './src/vendor/styles/rtl/theme-vibrant-dark.scss'
}
