<template>
  <div class="ui-block">
    <h3 class="ui-block-heading">SpinKit</h3>
    <a target="_blank" href="https://github.com/tobiasahlin/SpinKit" class="ui-block-description">https://github.com/tobiasahlin/SpinKit</a>
