  ...
  <div class="ui-block">
    ...
    <div class="cui-example cui-example-vertical-spacing-sm">
      ...
      <b-input-group append="@example.com">
        <b-input placeholder="Recipient's username" />
      </b-input-group>
      ...
      <b-input-group>
        ...
        <b-input-group-text slot="prepend">0.00</b-input-group-text>
        <b-input />
      </b-input-group>
    </div>
    ...
    <div class="cui-example cui-example-vertical-spacing-sm">
      <b-input-group>
        <b-select v-model="selected" :options="options" class="flex-grow-1" />
        <b-btn slot="append">Go!</b-btn>
      </b-input-group>

      <b-input-group>
        <b-input placeholder="Search for..." />
    ...
    <div class="cui-example">
      <div class="row">
        ...
        <div class="col-md">
          ...
          <b-form-group>
            <b-input-group>
              <b-btn slot="prepend">Hate it</b-btn>
              <b-input placeholder="Search for..." />
              <b-btn slot="append">Love it</b-btn>
            </b-input-group>
          </b-form-group>
    ...
    <div class="cui-example">
      <div class="row">
        <div class="col-md">
          ...
          <b-form-group>
            <b-input-group>
              <b-dd text="Action" :right="isRtlMode" slot="prepend">
        ...
        <div class="col-md">
          ...
          <b-form-group>
            <b-input-group>
              <b-input placeholder="Search for..." />
              <b-dd text="Action" :right="!isRtlMode" slot="append">
                <b-dd-item>Action 1</b-dd-item>
                <b-dd-item>Action 2</b-dd-item>
              </b-dd>
            </b-input-group>
    ...
    <div class="cui-example">
      <div class="row">
        <div class="col-md">
          ...
          <b-form-group>
            <b-input-group>
              <b-dd split text="Action" :right="isRtlMode" slot="prepend">
                <b-dd-item>Action 1</b-dd-item>
                <b-dd-item>Action 2</b-dd-item>
              </b-dd>
              <b-input placeholder="Search for..." />
        ...
        <div class="col-md">
          ...
          <b-form-group>
            <b-input-group>
              <b-input placeholder="Search for..." />
              <b-dd split text="Action" :right="!isRtlMode" slot="append">
                <b-dd-item>Action 1</b-dd-item>
                <b-dd-item>Action 2</b-dd-item>
              </b-dd>
            </b-input-group>
