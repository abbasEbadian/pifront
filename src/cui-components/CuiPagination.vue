<template>
  <div class="ui-block ui-block-inline ui-block-pagination">
    <h3 class="ui-block-heading">Pagination</h3>
    ...
    <h4 class="ui-block-heading">Pills</h4>

    <div class="cui-example cui-example-vertical-spacing-sm">
      <b-pagination pills :total-rows="100" v-model="currentPage" :per-page="10" />
      <b-pagination pills size="sm" :total-rows="100" v-model="currentPage" :per-page="10" />
      <b-pagination pills size="lg" :total-rows="100" v-model="currentPage" :per-page="10" />
    </div>
  </div>
</template>
