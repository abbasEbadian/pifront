<template>
  <div>
    ...
    <b-card style="width:50%; float: left  ; margin: 1.5% ;margin-top:30px; border-radius:15px; border-style:none">

          <b-form-group  label="">
            <b-input placeholder="کلمه عبور قبلی" v-model="opass" type="password" class="mb-1 optool" />
            <div class="invalid-tooltip">{{optool}}</div>
            <div class="clear"></div>
          </b-form-group>
          <b-form-group  label="">
            <b-input placeholder="کلمه عبور جدید" v-model="pass" type="password" class="mb-1 ptool" />
            <div class="invalid-tooltip">{{ptool}}</div>
            <div class="clear"></div>
          </b-form-group>

          <b-form-group  label="">
            <b-input placeholder="تکرار کلمه عبور" type="password" v-model="rpass" class="rptool" />
