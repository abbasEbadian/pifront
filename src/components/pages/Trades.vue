...
export default {
  ...
  methods: {
    async gettrade () {
      await axios
        .post(`/maintrades/${this.$route.params.id}`)
        .then(response => {
    ...
    async sellsubmit () {
      ...
      await axios
        .post(`/maintradesellorders/${this.$route.params.id}`, formData)
        .then(response => {
          location.reload()
        })
        .catch(error => {
    ...
    async buysubmit () {
      ...
      await axios
        .post(`/maintradebuyorders/${this.$route.params.id}`, formData)
        .then(response => {
          location.reload()
        })
        .catch(() => {
    ...
    async gettradebuyorders () {
      await axios
        .get(`/maintradebuyorders/${this.$route.params.id}`)
        .then(response => {
    ...
    async gettradesellorders () {
      await axios
        .get(`/maintradesellorders/${this.$route.params.id}`)
        .then(response => {
    ...
    async gettradeinfo () {
      await axios
        .get(`/maintradesinfo/${this.$route.params.id}`)
        .then(response => {
