        ...
        <b-card no-body class="mb-4">
          ...
          <b-card-body class="py-3">
            ...
            <div class="d-flex flex-wrap">
              <a v-for="member in project.team" :key="member.avatar" href="javascript:void(0)" class="d-block mr-1 mb-1"><img :src="`${publicUrl}img/avatars/${member.avatar}`" alt="" class="ui-w-30 rounded-circle"></a>
            </div>
          </b-card-body>
