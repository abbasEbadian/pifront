  ...
  <table style="border-top:transparent!important;border-radius:11px" class="table table-striped" :class="{'table-dark': store.state.dark === 'true'}" >
    <thead>
      <tr style="border-style:none!important">
        ...
        <th style="padding:20px; text-align:center ; font-family:'arial'" class="col-4" @click="sort(1)">Price</th>
        <th style="padding:20px; text-align:center ; font-family:'arial'" class="col-4" @click="sort(1)">Fiat Price(USD)</th>
        <th style="padding:20px; text-align:center ; font-family:'arial'" class="col-4" @click="sort(2)">Volume</th>
      </tr>
    </thead>
    <tbody>
      ...
      await axios
        ...
        .then(response => {
          ...
          for(var item in response.data){
            this.cats.push([item , response.data[item].last , response.data[item].vol ])
          }
