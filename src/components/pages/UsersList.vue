    ...
    <div class="ui-bordered px-4 pt-4 mb-4">
      <div class="form-row align-items-center">
        ...
        <div class="col-md mb-4">
          ...
          <flat-pickr v-model="filterLatestActivity" :config="{ altInput: true, animate: !isRtlMode, dateFormat: 'm/d/Y', altFormat: 'm/d/Y', mode: 'range' }" :placeholder="!isIEMode ? 'Any' : null" />
        </div>
      ...
      <div class="table-responsive">
        ...
        <b-table
          ...
          <template v-slot:cell(actions)>
            ...
            <b-dropdown variant="default btn-xs icon-btn md-btn-flat hide-arrow" :right="!isRtlMode">
