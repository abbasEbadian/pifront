          ...
          <div class="row no-gutters">
            <div v-for="attachment in projectData.attachments" :key="attachment.path" class="col-md-6 col-lg-12 col-xl-6 p-1">
              ...
              <div class="project-attachment ui-bordered p-2">
                <div v-if="isImage(attachment)" :style="{'background-image': `url(${publicUrl}${attachment.path})`}" class="project-attachment-img"></div>
          ...
          <b-tab title="Tasks" active>
            ...
            <div v-for="(section, index) in projectData.taskSections" :key="section.title">
              <b-card-body>
                ...
                <draggable v-model="section.tasks" v-bind="draggableOptions" class="project-task-list custom-controls-stacked">
          ...
          <b-tab title="Discussion">
            <b-card-body>
              ...
              <div v-for="message in projectData.discussion" :key="message.date + message.user.name" class="media mb-3">
                <div>
                  <img :src="`${publicUrl}img/avatars/${message.user.avatar}`" class="ui-w-40 rounded-circle" alt>
            ...
            <b-card-body>
              ...
              <div v-for="activity in projectData.activities" :key="activity.type + activity.date + activity.user.name" class="media pb-1 mb-3">
                <div class="ui-feed-icon-container">
                  ...
                  <span v-if="activity.type === 'pushed_commit'" class="ui-icon ui-feed-icon ion ion-md-code bg-warning text-body"></span>
                  ...
                  <img :src="`${publicUrl}img/avatars/${activity.user.avatar}`" class="ui-w-40 rounded-circle" alt>
                </div>
        ...
        <b-card no-body class="mb-4">
          ...
          <b-list-group :flush="true">
            ...
            <b-list-group-item class="d-flex justify-content-between align-items-center">
              ...
              <b-dropdown :variant="priorityDropdownVariant(projectData.priority)" :right="!isRtlMode">
          ...
          <b-list-group :flush="true">
            <div v-for="leader in projectData.leaders" :key="leader.name" class="list-group-item">
              <div class="media align-items-center">
                <img :src="`${publicUrl}img/avatars/${leader.avatar}`" class="d-block ui-w-30 rounded-circle" alt="">
        ...
        <b-card no-body class="mb-4">
          ...
          <b-list-group :flush="true">
            <li v-for="member in projectData.team" :key="member.name" class="list-group-item">
              <div class="media align-items-center">
                <img :src="`${publicUrl}img/avatars/${member.avatar}`" class="d-block ui-w-30 rounded-circle" alt="">
                <div class="media-body px-2">
