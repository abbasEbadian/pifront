  ...
  <div style="padding:5%">
    ...
    <h3 class="row align-items-center font-weight-bold py-4 mb-4">
      ...
      <div class="col-sm-6 col-md-4 col-xl-3 mt-4 mt-sm-0">
        <b-input size="lg" placeholder="Search Tutorial..." />
      </div>
    </h3>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Getting started</b-card-header>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Accounts</b-card-header>
      <div class="row no-gutters row-bordered">
        <div class="col-md-6 p-5">
          <h6 class="mb-4">Maecenas nec augue placerat</h6>
          <a href="javascript:void(0)" class="d-block mb-3"><i class="ion ion-ios-arrow-forward"></i>&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Membership</b-card-header>
      <div class="row no-gutters row-bordered">
        <div class="col-md-6 p-5">
          <h6 class="mb-4">Maecenas nec augue placerat</h6>
          <a href="javascript:void(0)" class="d-block mb-3"><i class="ion ion-ios-arrow-forward"></i>&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Privacy</b-card-header>
      <div class="row no-gutters row-bordered">
        <div class="col-md-6 p-5">
          <h6 class="mb-4">Maecenas nec augue placerat</h6>
          <a href="javascript:void(0)" class="d-block mb-3"><i class="ion ion-ios-arrow-forward"></i>&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Issues</b-card-header>
      <div class="row no-gutters row-bordered">
        <div class="col-md-6 p-5">
          <h6 class="mb-4">Maecenas nec augue placerat</h6>
          <a href="javascript:void(0)" class="d-block mb-3"><i class="ion ion-ios-arrow-forward"></i>&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
    ...
    <b-card no-body class="mt-5">
      <b-card-header header-tag="h5" class="py-4 px-5">Contacts</b-card-header>
      <div class="row no-gutters row-bordered">
        <div class="col-md-6 p-5">
          <h6 class="mb-4">Maecenas nec augue placerat</h6>
          <a href="javascript:void(0)" class="d-block mb-3"><i class="ion ion-ios-arrow-forward"></i>&nbsp; Lorem ipsum dolor sit amet, consectetur adipiscing elit.</a>
